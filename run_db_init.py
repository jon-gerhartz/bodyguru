...
run_list = [init_exercise_types, init_muscle_group_name, init_exercise_equipment, init_workout_type, init_exercises, init_workouts, init_users, init_workout_logs,
            ...
            add_status_to_users, add_status_foreign_key, init_password_reset_request, init_user_preferences, add_assistant_mode_to_user_preferences, init_assistant_conversations, init_assistant_messages, add_assistant_messages_conversation_id, init_workout_shares, add_column_video_slug]
