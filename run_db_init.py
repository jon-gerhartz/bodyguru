...
run_list = [init_exercise_types, init_muscle_group_name, init_exercise_equipment, init_workout_type, init_exercises, init_workouts, init_users, init_workout_logs,
            ...
            add_status_to_users, add_status_foreign_key, init_password_reset_request, init_user_preferences, init_workout_shares, init_workout_email_invites, add_column_video_slug]
