...
run_list = [init_exercise_types, init_muscle_group_name, init_exercise_equipment, init_workout_type, init_exercises, init_workouts, init_users, init_workout_logs,
            ...
            insert_muscle_group_names, insert_workout_types, add_link_to_exercises, init_user_status, add_name_to_users,
            add_status_to_users, add_status_foreign_key, insert_user_status, init_password_reset_request]
